...
| `ensemble_manager_v2.py` | API-friendly deployment manager: list deployments, fetch manifests, read saved YAML, submit/shutdown ensembles. | `get_deployments_for_web()`, `get_deployment_status()`, `deploy_ensemble()` | `ensemble.py`, `stream.py` |
