...
def stub_external_modules(tmp_path_factory):
    ...
    mod_org_service = add_submodule("organization_service")

    class DummyOrganizationService:
        def join_organization(self, *args, **kwargs):
    ...
    mod_org_service.OrganizationService = DummyOrganizationService

    mod_org_manager = add_submodule("organization_manager")
    mod_org_manager.OrganizationManager = DummyOrganizationService
